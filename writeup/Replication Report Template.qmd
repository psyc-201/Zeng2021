...
# Import dataframe 
data_path = '/Zeng2021/analysis/all_sub_data.csv'
...
diff_err_gist = error_df['avg_ind_error_session_2'].to_numpy() - error_df['avg_gist_error_session_1'].to_numpy()
...
Memory bias is attracted toward the gist memory after 1 day of learning
Memory bias becomes more attracted to gist memory over time (trend but NS)
